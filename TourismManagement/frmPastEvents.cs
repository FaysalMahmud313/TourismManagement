...
{
    public partial class frmPastEvents : Form
    {
        private string travelerID;
        public frmPastEvents(string travelerId)
        {
            InitializeComponent();
        ...
        private void LoadTravelerHistory(string travelerId)
        {
            try
            {
                string query = @"
        ...
        private void frmPastEvents_Load(object sender, EventArgs e)
        {
            LoadTravelerHistory(travelerID);
        }
    }
}
